...
CREATE TABLE `sadaf`.`comment` (
    ...
    `post-id` int(30) NOT NULL,
    `comment` tinytext COLLATE utf8_persian_ci,
    KEY `post-id` (`post-id`)
...
CREATE TABLE `sadaf`.`follow` (
    `following-user` varchar(15) COLLATE utf8_persian_ci NOT NULL,
    `followed-user` varchar(15) COLLATE utf8_persian_ci NOT NULL,
    KEY `following-user` (`following-user`)
    ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
INSERT INTO `follow` (`following-user`, `followed-user`) VALUES
('mobinapooladi', 'mahdipasyegane'),
('mobinapooladi', 'amirroshandel'),
('mobinapooladi', 'matinkoohjani'),
('mahdipasyegane', 'matinkoohjani'),
('mahdipasyegane', 'amirroshandel'),
('mahdipasyegane', 'mobinapooladi'),
('amirroshandel', 'mahdipasyegane'),
('amirroshandel', 'matinkoohjani'),
('amirroshandel', 'masudakhgar'),
('amirroshandel', 'mobinapooladi'),
('masudakhgar', 'amirroshandel'),
('masudakhgar', 'matinkoohjani'),
('maryamhokmabadi', 'matinkoohjani'),
('maryamhokmabadi', 'amirroshandel');
COMMIT;
...
CREATE TABLE `sadaf`.`post` (
    `username` varchar(15) COLLATE utf8_persian_ci NOT NULL,
    `post-id` int(30) NOT NULL AUTO_INCREMENT,
    `text` tinytext COLLATE utf8_persian_ci,
    `image` varchar(15) COLLATE utf8_persian_ci DEFAULT NULL,
    `date` date NOT NULL,
    PRIMARY KEY (`post-id`),
...
INSERT INTO `post` (`username`, `post-id`, `text`, `image`, `date`) VALUES
('mahdipasyegane', 1, 'سلااااام', '', '2021-06-07'),
('mobinapooladi', 2, 'سلاااام', '', '2021-06-07'),
('amirroshandel', 3, 'سلاااام', '', '2021-06-07'),
('matinkoohjani', 4, 'سلاااام', '', '2021-06-07'),
('masudakhgar', 5, 'سلاااام', '', '2021-06-07'),
('maryamhokmabadi', 6, 'سلاااام', '', '2021-06-07');
COMMIT;
...
CREATE TABLE `sadaf`.`profile` (
    ...
    `bio` tinytext COLLATE utf8_persian_ci,
    `image` varchar(15) COLLATE utf8_persian_ci DEFAULT NULL,
...
INSERT INTO `profile` (`username`, `name`, `bio`, `image`) VALUES
('mahdipasyegane', 'mahdi', 'hello im mahdi', ''),
('mobinapooladi', 'mobina', 'hello im mobina', ''),
('amirroshandel', 'amir', 'hello im amir', ''),
('matinkoohjani', 'matin', 'hello im matin', ''),
('masudakhgar', 'masud', 'hello im masud', ''),
('maryamhokmabadi', 'maryam', 'hello im maryam', '');
COMMIT;
...
CREATE TABLE `sadaf`.`user` (
    `username` varchar(15) COLLATE utf8_persian_ci NOT NULL,
    `pass` varchar(15) COLLATE utf8_persian_ci NOT NULL,
...
('mahdipasyegane', 'mahdi1234', 'mahdipasyegane@gmail.com'),
('mobinapooladi', 'mobina1234', 'mobinapooladi@gmail.com'),
('amirroshandel', 'amir1234', 'amirroshandel@gmail.com'),
('matinkoohjani', 'matin1234', 'matinkoohjani@gmail.com'),
('masudakhgar', 'masud1234', 'masudakhgar@gmail.com'),
('maryamhokmabadi', 'maryam1234', 'maryamhokmabadi@gmail.com');
COMMIT;
